...
int main(int argc, char **argv)
{
    ...
    sim_lib = LoadLibrary(TEXT("isim/_tmp/work/ALU8Bit_tb_tbxr.exe_lib.nt.dll"));
    if (!sim_lib)
    {
        fprintf(stderr, "Could not open simulation library isim/_tmp/work/ALU8Bit_tb_tbxr.exe_lib.nt.dll\n");
        return 1;
    }
